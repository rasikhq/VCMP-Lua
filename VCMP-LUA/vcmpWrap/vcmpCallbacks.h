...
void RegisterVCMPCallbacks() {
...
#endif
		try {
			sol::unsafe_function fn = Lua["onServerInit"];
			if (fn.valid())
				fn();
		}
		catch (sol::error e) {
...
#endif
		try {
			sol::unsafe_function fn = Lua["onServerShutdown"];
			if (fn.valid())
				fn();
		}
		catch (sol::error e) {
...
#endif
		try {
			sol::unsafe_function fn = Lua["onPluginCommand"];
			if (fn.valid())
...
#endif
		try {
			sol::unsafe_function fn = Lua["onPlayerConnection"];
			if (fn.valid())
	...
	g_Calls->OnPlayerConnect = [](int32_t playerId) {
		...
		try {
			sol::unsafe_function fn = Lua["onPlayerConnect"];
			if (fn.valid())
				fn(player);
		}
		catch (sol::error e) {
...
//		try {
//			sol::unsafe_function fn = Lua["onPlayerDisconnect"];
//			if (fn.valid())
//				fn(player);
//		}
//		catch (sol::error e) {
...
//		uint8_t ret = 1;
//		try {
//			sol::unsafe_function fn = Lua["onPlayerRequestClass"];
//			if (fn.valid()) {
...
//		uint8_t ret = 1;
//		try {
//			sol::unsafe_function fn = Lua["onPlayerRequestSpawn"];
//			if (fn.valid()) {
//				luabridge::LuaRef result = fn(player);
//				if (result.isNumber())
//					ret = result.cast<uint8_t>();
...
//
	g_Calls->OnPlayerSpawn = [](int32_t playerId) {
		...
		Player* player = Player::Get(playerId);
		try {
			sol::unsafe_function fn = Lua["onPlayerSpawn"];
			if (fn.valid())
				fn(player);
		}
		catch (sol::error e) {
...
//			try {
//				Player* player = Player::Get(playerId);
//				sol::unsafe_function fn = Lua["onPlayerWasted"];
//				if (fn.valid()) {
...
//			sol::unsafe_function fn = Lua["onPlayerKill"];
//			if (fn.valid())
...
//		Player* player = Player::Get(playerId);
//		try {
//			sol::unsafe_function fn = Lua["onPlayerUpdate"];
//			if (fn.valid())
//				fn(player);
//		}
//		catch (sol::error e) {
...
//			sol::unsafe_function fn = Lua["onPlayerRequestEnterVehicle"];
//			if (fn.valid()) {
...
//			Player* player = Player::Get(playerId);
//			Vehicle* vehicle = Vehicle::Get(vehicleId);
//			sol::unsafe_function fn = Lua["onPlayerEnterVehicle"];
//			if (fn.valid())
...
//			Player* player = Player::Get(playerId);
//			Vehicle* vehicle = Vehicle::Get(vehicleId);
//			sol::unsafe_function fn = Lua["onPlayerExitVehicle"];
//			if (fn.valid())
//				fn(player, vehicle);
//		}
//		catch (sol::error e) {
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerNameChange"];
//			if (fn.valid())
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerStateChange"];
//			if (fn.valid())
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerActionChange"];
//			if (fn.valid())
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerFireChange"];
//			if (fn.valid())
//				fn(player, isOnFire);
//		}
//		catch (sol::error e) {
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerCrouchChange"];
//			if (fn.valid())
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerGameKeysChange"];
//			if (fn.valid())
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerBeginTyping"];
//			if (fn.valid())
//				fn(player);
//		}
//		catch (sol::error e) {
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerFinishTyping"];
//			if (fn.valid())
//				fn(player);
//		}
//		catch (sol::error e) {
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerAwayChange"];
//			if (fn.valid())
//				fn(player, isAway);
//		}
//		catch (sol::error e) {
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerMessage"];
//			if (fn.valid()) {
...
//			sol::unsafe_function fn = Lua["onPlayerPM"];
//			if (fn.valid()) {
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerKeyDown"];
//			if (fn.valid())
//				fn(player, bindId);
//		}
//		catch (sol::error e) {
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerKeyUp"];
//			if (fn.valid())
//				fn(player, bindId);
//		}
//		catch (sol::error e) {
...
//			Player* player = Player::Get(playerId);
//			Player* targetPlayer = Player::Get(targetPlayerId);
//			sol::unsafe_function fn = Lua["onPlayerSpectate"];
//			if (fn.valid())
...
//		try {
//			Player* player = Player::Get(playerId);
//			sol::unsafe_function fn = Lua["onPlayerCrashReport"];
//			if (fn.valid())
//				fn(player, report);
//		}
//		catch (sol::error e) {
...
//		try {
//			Vehicle* vehicle = Vehicle::Get(vehicleId);
//			sol::unsafe_function fn = Lua["onVehicleUpdate"];
//			if (fn.valid())
//				fn(vehicle);
//		}
//		catch (sol::error e) {
...
//		try {
//			Vehicle* vehicle = Vehicle::Get(vehicleId);
//			sol::unsafe_function fn = Lua["onVehicleExplode"];
//			if (fn.valid())
//				fn(vehicle);
//		}
//		catch (sol::error e) {
...
//		try {
//			Vehicle* vehicle = Vehicle::Get(vehicleId);
//			sol::unsafe_function fn = Lua["onVehicleRespawn"];
//			if (fn.valid())
//				fn(vehicle);
//		}
//		catch (sol::error e) {
